  ...
  return {
    ...
    x: common_vendor.f($data.swipeList, (item, index, i0) => {
      return {
        ...
        e: "404b59b6-14-" + i0 + ",404b59b6-13",
        f: common_vendor.p({
          ["right-options"]: item.options
        })
      };
    }),
    y: common_vendor.sr("swipeAction", "404b59b6-13")
  };
}
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "/Users/aldno/Documents/AccessoryAssistant/AccessoryAssistant/pages/extUI/swipe-action/swipe-action.vue"]]);
