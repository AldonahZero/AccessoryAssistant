  ...
  return {
    ...
    e: common_vendor.f($data.tableData, (item, index, i0) => {
      return {
        ...
        b: "04737ef4-7-" + i0 + "," + ("04737ef4-6-" + i0),
        c: common_vendor.t(item.name),
        d: "04737ef4-8-" + i0 + "," + ("04737ef4-6-" + i0),
        e: common_vendor.t(item.address),
        f: "04737ef4-9-" + i0 + "," + ("04737ef4-6-" + i0),
        g: "04737ef4-10-" + i0 + "," + ("04737ef4-6-" + i0),
        h: index,
        i: "04737ef4-6-" + i0 + ",04737ef4-0"
      };
    }),
    f: common_vendor.p({
      align: "center"
    }),
    g: common_vendor.sr("table", "04737ef4-0"),
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "/Users/aldno/Documents/AccessoryAssistant/AccessoryAssistant/pages/extUI/table/table.vue"]]);
